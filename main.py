...
parser.add_argument("--log_folder", default="training_8x_to_256", type=str, help="Folder to save weights")
...
parser.add_argument("--src_folder", default="images", type=str, help="Folder with images to upscale")
parser.add_argument("--dst_folder", default="sr_images", type=str, help="Folder to save results")
